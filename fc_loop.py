...
if __name__ == '__main__':
    ...
    if initial_gen == 0:
        ...
        subprocess.run(["julia","search_fc.jl", args.dump_path, str(args.nb_local_searches), str(args.num_initial_empty_objects), str(args.final_database_size), str(args.target_db_size), '-i', 'data/elliptic_input_with_fourier_coefficients.txt'])
